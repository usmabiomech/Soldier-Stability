function [SCORE_RPE,SCORE_OBJSUM,SCORE_OBJMEAN]=TheFinalCountdownScore(slope,avg_T_ang_std,D_avg_stances,D_std_stances,std_accel_1,std_accel_both,avg_peak_accel_1,avg_peak_accel_both)

% TheFinalCountdownScore(slope,avg_T_ang_std,LyE_LF,D_LyE_TF,D_LyE_TS,D_LyE_SF,D_avg_stances,D_std_stances,std_accel_both,avg_peak_accel_both)
...
pc_1=(f_1(length(f_1))-f_1(1))/f_1(1);
score(1)=slope(1)*pc_1;
...
% pc_2=(f_2(length(f_2))-f_2(1))/f_2(1);
% score(2)=slope(2)*pc_2;
...
% pc_3_TF=(f_3_TF(length(f_3_TF))-f_3_TF(1))/f_3_TF(1);
% score(3)=RPE/pc_base(3)*pc_3_TF;
% 
...
% pc_3_TS=(f_3_TS(length(f_3_TS))-f_3_TS(1))/f_3_TS(1);
% score(4)=RPE/pc_base(4)*pc_3_TS;
% 
...
% pc_3_SF=(f_3_SF(length(f_3_SF))-f_3_SF(1))/f_3_SF(1);
% score(5)=RPE/pc_base(5)*pc_3_SF;
...
pc_4=(f_4(length(f_4))-f_4(1))/f_4(1);
% score(6)=RPE/pc_base(6)*pc_4;
score(2)=slope(2)*pc_4;
...
pc_5=(f_5(length(f_5))-f_5(1))/f_5(1);
% score(7)=RPE/pc_base(7)*pc_5;
score(3)=slope(3)*pc_5;
...
pc_6=(f_6(length(f_6))-f_6(1))/f_6(1);
% score(8)=RPE/pc_base(8)*pc_6;
score(4)=slope(4)*pc_6;
...
pc_6_1=(f_6_1(length(f_6_1))-f_6_1(1))/f_6_1(1);
% score(9)=RPE/pc_base(9)*pc_6_1;
score(5)=slope(5)*pc_6_1;
...
pc_7=(f_7(length(f_7))-f_7(1))/f_7(1);
% score(10)=RPE/pc_base(10)*pc_7;
score(6)=slope(6)*pc_7;
...
pc_7_1=(f_7_1(length(f_7_1))-f_7_1(1))/f_7_1(1);
% score(11)=RPE/pc_base(11)*pc_7_1;
score(7)=slope(7)*pc_7_1;

SCORE_RPE=mean(score);
% SCORE_OBJSUM=sum(abs([pc_1,pc_2,pc_3_TF,pc_3_TS,pc_3_SF,pc_4,pc_5,pc_6,pc_6_1,pc_7,pc_7_1]));
SCORE_OBJSUM=sum(abs([pc_1,pc_4,pc_5,pc_6,pc_6_1,pc_7,pc_7_1]));
% SCORE_OBJMEAN=mean(abs([pc_1,pc_2,pc_3_TF,pc_3_TS,pc_3_SF,pc_4,pc_5,pc_6,pc_6_1,pc_7,pc_7_1]));
SCORE_OBJMEAN=mean(abs([pc_1,pc_4,pc_5,pc_6,pc_6_1,pc_7,pc_7_1]));
