function [RPE,avg_T_ang_std,D_avg_stances,D_std_stances,std_accel_1,std_accel_both,avg_peak_accel_1,avg_peak_accel_both] = TheFinalCountdownBASELINE(filename)

% [RPE,avg_T_ang_std,LyE_LF,D_LyE_TF,D_LyE_TS,D_LyE_SF,D_avg_stances,D_std_stances,std_accel_both,avg_peak_accel_both]
...
% prompt='What is your Rate of Perceived Exertion? (1-10)';
% RPE=input(prompt);
% HARD CODE RPE; cannot receive input in C coder
RPE=8;
